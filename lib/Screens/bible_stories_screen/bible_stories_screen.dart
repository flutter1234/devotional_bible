                                        ...
                                        onTap: () {
                                          AdsRN().showFullScreen(
                                            ...
                                            onComplete: () {
                                              Navigator.pushNamed(
                                                context,
                                                devotional_bible_view_screen.routeName,
                                                arguments: {
                                                  "View All": dataProvider.bibleStoriesList['Bible Stories'][index][dataProvider.keyList[index]],
                                                  "KeyName": dataProvider.keyList[index],
                                                },
                                              );
                                            },
                                          );
